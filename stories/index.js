...
storiesOf("Test")
    .add("Random div", () => <div>hello world</div>)
  ...
  storiesOf("Appointment", module)
    ...
    .add("Status", () => <Status messege="Deleting..." />)
    .add("Error", () => <Error messege = "Could not delete appointment." onClose = {action("onClose")}/> )
    .add("Edit", () => <Form name="Honeyeh" interviewers={interviewers} interviewer={3} onSave={action("onSave")} onCancel={action("onCancel")}/>)
